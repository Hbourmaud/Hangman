	...
	for i := 0; i <= len(tableauX); i++ {
		if i == len(tableauX) {
			if (letter[0] > 231 && letter[0] < 236) || (letter[0] > 199 && letter[0] < 204) || letter[0] == 101 || letter[0] == 69 {
				...
				break
			} else if (letter[0] > 223 && letter[0] < 230) || (letter[0] > 191 && letter[0] < 198) || letter[0] == 97 || letter[0] == 65 {
				...
				break
			} else if (letter[0] > 235 && letter[0] < 240) || (letter[0] > 203 && letter[0] < 208) || letter[0] == 105 || letter[0] == 73 {
				...
				break
			} else if (letter[0] > 241 && letter[0] < 247) || (letter[0] > 209 && letter[0] < 215) || letter[0] == 111 || letter[0] == 79 {
				...
				break
			} else if (letter[0] > 248 && letter[0] < 253) || (letter[0] > 216 && letter[0] < 221) || letter[0] == 117 || letter[0] == 85 {
